...
import {
  useSelectionBounds,
} from "@/lib/hooks/use_selection_bounds";
import { CanvasLayerType, SelectionBoxProps, Side } from "@/lib/types";
...
const SelectionBox = ({ onResizeHandlePointerDown }: SelectionBoxProps) => {
  ...
  const isShowingHandles = useStorage(
    (root) =>
      soleLayerID && root.layers.get(soleLayerID)?.type !== CanvasLayerType.Path
  );
